...
var DietaryOption = function (_BaseObject) {
  _inherits(DietaryOption, _BaseObject);

  function DietaryOption(object) {
    _classCallCheck(this, DietaryOption);

    var _this = _possibleConstructorReturn(this, (DietaryOption.__proto__ || Object.getPrototypeOf(DietaryOption)).call(this, object, 'DietaryOption'));
...
DietaryOption.spawn = function (info) {
  var object = new DietaryOption();
...
DietaryOption.updateInfoInternal = function (object, info) {
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.updateInfo = function (info) {
    DietaryOption.updateInfoInternal(_this2.getObject(), info);
