...
var _MenuItemPriceService = require('../../services/__tests__/MenuItemPriceService.test');

var _MenuItemPriceService2 = _interopRequireDefault(_MenuItemPriceService);
...
var createMenuInfo = exports.createMenuInfo = function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    var ownedByUser, maintainedByUsers, tags, menuItemPrices, menu;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 8:
            tags = _context.sent;
            _context.next = 11;
            return (0, _MenuItemPriceService2.default)(chance.integer({ min: 1, max: 3 }));
          ...
          case 11:
            ...
            menu = (0, _immutable.Map)({
              ...
              menuItemPriceIds: menuItemPrices.map(function (menuItemPrice) {
...
var expectMenu = exports.expectMenu = function expectMenu(object, expectedObject) {
  var _ref3 = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {},
      menuId = _ref3.menuId,
      expectedMenuItemPrices = _ref3.expectedMenuItemPrices,
  ...
  if (expectedMenuItemPrices) {
    expect(object.get('menuItemPriceIds')).toEqual(expectedMenuItemPrices.map(function (_) {
      return _.get('id');
    }));
  }
