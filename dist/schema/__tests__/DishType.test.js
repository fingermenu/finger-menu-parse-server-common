...
exports.expectDishType = exports.createDishType = exports.createDishTypeInfo = undefined;
...
var createDishTypeInfo = exports.createDishTypeInfo = function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    var tag, ownedByUser, maintainedByUsers, dishType;
...
var createDishType = exports.createDishType = function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.next = 5;
            return createDishTypeInfo();

          case 5:
            _context2.t1 = _context2.sent.dishType;
  ...
  return function createDishType(_x) {
    return _ref2.apply(this, arguments);
  };
}();

var expectDishType = exports.expectDishType = function expectDishType(object, expectedObject) {
  var _ref3 = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {},
      dishTypeId = _ref3.dishTypeId,
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.t0 = expect;
            _context3.next = 3;
            return createDishType();

          case 3:
            _context3.t1 = _context3.sent.className;
            (0, _context3.t0)(_context3.t1).toBe('DishType');
...
describe('static public methods', function () {
  test('spawn should set provided info', _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4() {
    var _ref6, dishType, object, info;
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 2:
            ...
            dishType = _ref6.dishType;
            _context4.next = 6;
            return createDishType(dishType);
...
describe('public methods', function () {
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 2:
            ...
            expect(new _.DishType(object).getObject()).toBe(object);
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          ...
          case 2:
            ...
            expect(new _.DishType(object).getId()).toBe(object.id);
  ...
  test('updateInfo should update object info', _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7() {
    var object, _ref10, updatedDishType, info;
      ...
      while (1) {
        switch (_context7.prev = _context7.next) {
          ...
          case 5:
            ...
            updatedDishType = _ref10.dishType;
  ...
  test('getInfo should return provided info', _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee8() {
    var _ref12, dishType, object, info;
