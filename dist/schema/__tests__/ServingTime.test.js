...
exports.expectServingTime = exports.createServingTime = exports.createServingTimeInfo = undefined;
...
var createServingTimeInfo = exports.createServingTimeInfo = function () {
  ...
  return function createServingTimeInfo() {
    return _ref.apply(this, arguments);
  };
}();

var createServingTime = exports.createServingTime = function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(object) {
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.t0 = _.ServingTime;
            _context2.t1 = object;
  ...
  return function createServingTime(_x) {
    return _ref2.apply(this, arguments);
  };
}();

var expectServingTime = exports.expectServingTime = function expectServingTime(object, expectedObject) {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.t0 = expect;
            _context3.next = 3;
            return createServingTime();

          case 3:
            _context3.t1 = _context3.sent.className;
            (0, _context3.t0)(_context3.t1).toBe('ServingTime');
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 2:
            ...
            _context4.next = 6;
            return createServingTime(servingTime);
...
describe('public methods', function () {
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 2:
            ...
            expect(new _.ServingTime(object).getObject()).toBe(object);
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          ...
          case 2:
            ...
            expect(new _.ServingTime(object).getId()).toBe(object.id);
  ...
  test('updateInfo should update object info', _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7() {
    var object, _ref10, updatedServingTime, info;
      ...
      while (1) {
        switch (_context7.prev = _context7.next) {
          ...
          case 5:
            ...
            updatedServingTime = _ref10.servingTime;
