...
var _DietaryOption = require('../../schema/__tests__/DietaryOption.test');
...
var serviceTimeService = new _2.DietaryOptionService();
...
var createDietaryOptions = function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(count) {
    ...
    var serviceTime, _ref2, tempDietaryOption;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.next = 4;
            return (0, _DietaryOption.createDietaryOptionInfo)();

          case 4:
            _ref2 = _context2.sent;
            tempDietaryOption = _ref2.serviceTime;
          ...
          case 7:
            ...
            return Promise.all((0, _immutable.Range)(0, count).map(_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
              var finalDietaryOption, _ref4, _tempDietaryOption;

              return regeneratorRuntime.wrap(function _callee$(_context) {
                while (1) {
                  switch (_context.prev = _context.next) {
                    case 0:
                      finalDietaryOption = void 0;
                    ...
                    case 7:
                      _ref4 = _context.sent;
                      _tempDietaryOption = _ref4.serviceTime;


                      finalDietaryOption = _tempDietaryOption;

                    case 10:
                      _context.t0 = serviceTimeService;
                      _context.next = 13;
                      return serviceTimeService.create(finalDietaryOption);
  ...
  return function createDietaryOptions(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.default = createDietaryOptions;
    ...
    return regeneratorRuntime.wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 9:
            fetchedDietaryOption = _context4.sent;
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          ...
          case 12:
            ...
            (0, _DietaryOption.expectDietaryOption)(serviceTime, expectedDietaryOption, {
      ...
      while (1) {
        switch (_context8.prev = _context8.next) {
          ...
          case 2:
            ...
            expectedDietaryOption = _ref13.serviceTime;
          ...
          case 10:
            ...
            _context8.next = 13;
            return serviceTimeService.update(expectedDietaryOption.set('id', serviceTimeId));
      ...
      while (1) {
        switch (_context9.prev = _context9.next) {
          ...
          case 2:
            ...
            expectedDietaryOption = _ref15.serviceTime;
      ...
      while (1) {
        switch (_context14.prev = _context14.next) {
          ...
          case 2:
            ...
            expectedDietaryOption = _ref20.serviceTime;
              ...
              return regeneratorRuntime.wrap(function _callee13$(_context13) {
                while (1) {
                  switch (_context13.prev = _context13.next) {
                    case 0:
                      return _context13.abrupt('return', serviceTimeService.create(expectedDietaryOption));
          ...
          case 10:
            ...
            _context14.next = 14;
            return serviceTimeService.search(createCriteria(expectedDietaryOption));
      ...
      while (1) {
        switch (_context17.prev = _context17.next) {
          ...
          case 2:
            ...
            expectedDietaryOption = _ref24.serviceTime;
              ...
              return regeneratorRuntime.wrap(function _callee16$(_context16) {
                while (1) {
                  switch (_context16.prev = _context16.next) {
                    case 0:
                      return _context16.abrupt('return', serviceTimeService.create(expectedDietaryOption));
          ...
          case 10:
            ...
            serviceTimes = (0, _immutable.List)();
            result = serviceTimeService.searchAll(createCriteria(expectedDietaryOption));
            _context17.prev = 14;
    ...
    return regeneratorRuntime.wrap(function _callee19$(_context19) {
      while (1) {
        switch (_context19.prev = _context19.next) {
          case 0:
            _context19.next = 2;
            return createDietaryOptions(chance.integer({ min: 1, max: 10 }), true);
