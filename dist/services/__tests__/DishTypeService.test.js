...
var _DishType = require('../../schema/__tests__/DishType.test');
...
var serviceTimeService = new _2.DishTypeService();
...
var createDishTypes = function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(count) {
    ...
    var serviceTime, _ref2, tempDishType;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.next = 4;
            return (0, _DishType.createDishTypeInfo)();

          case 4:
            _ref2 = _context2.sent;
            tempDishType = _ref2.serviceTime;
          ...
          case 7:
            ...
            return Promise.all((0, _immutable.Range)(0, count).map(_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
              var finalDishType, _ref4, _tempDishType;

              return regeneratorRuntime.wrap(function _callee$(_context) {
                while (1) {
                  switch (_context.prev = _context.next) {
                    case 0:
                      finalDishType = void 0;
                    ...
                    case 7:
                      _ref4 = _context.sent;
                      _tempDishType = _ref4.serviceTime;


                      finalDishType = _tempDishType;

                    case 10:
                      _context.t0 = serviceTimeService;
                      _context.next = 13;
                      return serviceTimeService.create(finalDishType);
  ...
  return function createDishTypes(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.default = createDishTypes;


describe('create', function () {
  test('should return the created dish type Id', _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {
    var serviceTimeId;
  ...
  test('should create the dish type', _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4() {
    var _ref7, serviceTime, serviceTimeId, fetchedDishType;
    ...
    return regeneratorRuntime.wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 9:
            fetchedDishType = _context4.sent;
...
describe('read', function () {
  test('should reject if the provided dish type Id does not exist', _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5() {
    var serviceTimeId;
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 6:
            ...
            expect(_context5.t0.message).toBe('No dish type found with Id: ' + serviceTimeId);
  ...
  test('should read the existing dish type', _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6() {
    var _ref10, expectedDishType, expectedTag, expectedOwnedByUser, expectedMaintainedByUsers, serviceTimeId, serviceTime;
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          ...
          case 12:
            ...
            (0, _DishType.expectDishType)(serviceTime, expectedDishType, {
...
describe('update', function () {
  test('should reject if the provided dish type Id does not exist', _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7() {
      ...
      while (1) {
        switch (_context7.prev = _context7.next) {
          ...
          case 18:
            ...
            expect(_context7.t5.message).toBe('No dish type found with Id: ' + serviceTimeId);
  ...
  test('should return the Id of the updated dish type', _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee8() {
    var _ref13, expectedDishType, serviceTimeId, id;
      ...
      while (1) {
        switch (_context8.prev = _context8.next) {
          ...
          case 2:
            ...
            expectedDishType = _ref13.serviceTime;
          ...
          case 10:
            ...
            _context8.next = 13;
            return serviceTimeService.update(expectedDishType.set('id', serviceTimeId));
  ...
  test('should update the existing dish type', _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee9() {
    var _ref15, expectedDishType, expectedTag, expectedOwnedByUser, expectedMaintainedByUsers, serviceTimeId, serviceTime;
      ...
      while (1) {
        switch (_context9.prev = _context9.next) {
          ...
          case 2:
            ...
            expectedDishType = _ref15.serviceTime;
...
describe('delete', function () {
  test('should reject if the provided dish type Id does not exist', _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee10() {
    var serviceTimeId;
      ...
      while (1) {
        switch (_context10.prev = _context10.next) {
          ...
          case 6:
            ...
            expect(_context10.t0.message).toBe('No dish type found with Id: ' + serviceTimeId);
  ...
  test('should delete the existing dish type', _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee11() {
    var serviceTimeId;
      ...
      while (1) {
        switch (_context11.prev = _context11.next) {
          ...
          case 14:
            ...
            expect(_context11.t2.message).toBe('No dish type found with Id: ' + serviceTimeId);
...
describe('search', function () {
  test('should return no dish type if provided criteria matches no dish type', _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee12() {
    var serviceTimes;
  ...
  test('should return the dish type matches the criteria', _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee14() {
    var _ref20, expectedDishType, expectedTag, expectedOwnedByUser, expectedMaintainedByUsers, results, serviceTimes;
      ...
      while (1) {
        switch (_context14.prev = _context14.next) {
          ...
          case 2:
            ...
            expectedDishType = _ref20.serviceTime;
              ...
              return regeneratorRuntime.wrap(function _callee13$(_context13) {
                while (1) {
                  switch (_context13.prev = _context13.next) {
                    case 0:
                      return _context13.abrupt('return', serviceTimeService.create(expectedDishType));
          ...
          case 10:
            ...
            _context14.next = 14;
            return serviceTimeService.search(createCriteria(expectedDishType));
...
describe('searchAll', function () {
  test('should return no dish type if provided criteria matches no dish type', _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee15() {
  ...
  test('should return the dish type matches the criteria', _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee17() {
    var _ref24, expectedDishType, expectedTag, expectedOwnedByUser, expectedMaintainedByUsers, results, serviceTimes, result;
      ...
      while (1) {
        switch (_context17.prev = _context17.next) {
          ...
          case 2:
            ...
            expectedDishType = _ref24.serviceTime;
              ...
              return regeneratorRuntime.wrap(function _callee16$(_context16) {
                while (1) {
                  switch (_context16.prev = _context16.next) {
                    case 0:
                      return _context16.abrupt('return', serviceTimeService.create(expectedDishType));
          ...
          case 10:
            ...
            serviceTimes = (0, _immutable.List)();
            result = serviceTimeService.searchAll(createCriteria(expectedDishType));
            _context17.prev = 14;
...
describe('exists', function () {
  test('should return false if no dish type match provided criteria', _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee18() {
  ...
  test('should return true if any dish type match provided criteria', _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee19() {
    var serviceTimes;
    return regeneratorRuntime.wrap(function _callee19$(_context19) {
      while (1) {
        switch (_context19.prev = _context19.next) {
          case 0:
            _context19.next = 2;
            return createDishTypes(chance.integer({ min: 1, max: 10 }), true);
...
describe('count', function () {
  test('should return 0 if no dish type match provided criteria', _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee20() {
  ...
  test('should return the count of dish type match provided criteria', _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee21() {
    var serviceTimes;
