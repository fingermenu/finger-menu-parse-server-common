...
var createCriteriaWthoutConditions = function createCriteriaWthoutConditions() {
  return (0, _immutable.Map)({
    fields: _immutable.List.of('name', 'description', 'menuPageUrl', 'imageUrl', 'menuItems', 'tags', 'ownedByUser', 'maintainedByUsers'),
...
var createCriteria = function createCriteria(menu) {
  return (0, _immutable.Map)({
    conditions: (0, _immutable.Map)({
      ...
      menuItemIds: menu ? menu.get('menuItemIds') : _immutable.List.of((0, _v2.default)(), (0, _v2.default)()),
...
describe('read', function () {
  ...
  test('should read the existing menu', _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6() {
    var _ref10, expectedMenu, expectedMenuItems, expectedTags, expectedOwnedByUser, expectedMaintainedByUsers, menuId, menu;
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          ...
          case 2:
            ...
            expectedMenuItems = _ref10.menuItems;
...
describe('update', function () {
  ...
  test('should update the existing menu', _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee9() {
    var _ref15, expectedMenu, expectedMenuItems, expectedTags, expectedOwnedByUser, expectedMaintainedByUsers, menuId, menu;
      ...
      while (1) {
        switch (_context9.prev = _context9.next) {
          ...
          case 2:
            ...
            expectedMenuItems = _ref15.menuItems;
...
describe('search', function () {
  ...
  test('should return the menu matches the criteria', _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee14() {
    var _ref20, expectedMenu, expectedMenuItems, expectedTags, expectedOwnedByUser, expectedMaintainedByUsers, results, menus;
      ...
      while (1) {
        switch (_context14.prev = _context14.next) {
          ...
          case 2:
            ...
            expectedMenuItems = _ref20.menuItems;
...
describe('searchAll', function () {
  ...
  test('should return the menu matches the criteria', _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee17() {
    var _ref24, expectedMenu, expectedMenuItems, expectedTags, expectedOwnedByUser, expectedMaintainedByUsers, results, menus, result;
      ...
      while (1) {
        switch (_context17.prev = _context17.next) {
          ...
          case 2:
            ...
            expectedMenuItems = _ref24.menuItems;
