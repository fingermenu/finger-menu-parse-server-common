...
var _ServingTime = require('../../schema/__tests__/ServingTime.test');
...
var serviceTimeService = new _2.ServingTimeService();
...
var createServingTimes = function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(count) {
    ...
    var serviceTime, _ref2, tempServingTime;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 4:
            ...
            tempServingTime = _ref2.serviceTime;
          ...
          case 7:
            ...
            return Promise.all((0, _immutable.Range)(0, count).map(_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
              var finalServingTime, _ref4, _tempServingTime;

              return regeneratorRuntime.wrap(function _callee$(_context) {
                while (1) {
                  switch (_context.prev = _context.next) {
                    case 0:
                      finalServingTime = void 0;
                    ...
                    case 7:
                      _ref4 = _context.sent;
                      _tempServingTime = _ref4.serviceTime;


                      finalServingTime = _tempServingTime;

                    case 10:
                      _context.t0 = serviceTimeService;
                      _context.next = 13;
                      return serviceTimeService.create(finalServingTime);
  ...
  return function createServingTimes(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.default = createServingTimes;
...
describe('create', function () {
  ...
  test('should create the serving time', _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4() {
    var _ref7, serviceTime, serviceTimeId, fetchedServingTime;
    ...
    return regeneratorRuntime.wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 9:
            fetchedServingTime = _context4.sent;
...
describe('update', function () {
  ...
  test('should return the Id of the updated serving time', _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee8() {
    var _ref13, expectedServingTime, serviceTimeId, id;
      ...
      while (1) {
        switch (_context8.prev = _context8.next) {
          ...
          case 2:
            ...
            expectedServingTime = _ref13.serviceTime;
          ...
          case 10:
            ...
            _context8.next = 13;
            return serviceTimeService.update(expectedServingTime.set('id', serviceTimeId));
      ...
      while (1) {
        switch (_context14.prev = _context14.next) {
              ...
              return regeneratorRuntime.wrap(function _callee13$(_context13) {
                while (1) {
                  switch (_context13.prev = _context13.next) {
                    case 0:
                      return _context13.abrupt('return', serviceTimeService.create(expectedServingTime));
          ...
          case 10:
            ...
            _context14.next = 14;
            return serviceTimeService.search(createCriteria(expectedServingTime));
      ...
      while (1) {
        switch (_context17.prev = _context17.next) {
              ...
              return regeneratorRuntime.wrap(function _callee16$(_context16) {
                while (1) {
                  switch (_context16.prev = _context16.next) {
                    case 0:
                      return _context16.abrupt('return', serviceTimeService.create(expectedServingTime));
          ...
          case 10:
            ...
            serviceTimes = (0, _immutable.List)();
            result = serviceTimeService.searchAll(createCriteria(expectedServingTime));
            _context17.prev = 14;
    ...
    return regeneratorRuntime.wrap(function _callee19$(_context19) {
      while (1) {
        switch (_context19.prev = _context19.next) {
          case 0:
            _context19.next = 2;
            return createServingTimes(chance.integer({ min: 1, max: 10 }), true);
